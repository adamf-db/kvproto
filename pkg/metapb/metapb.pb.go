...
type Region struct {
	...
	/// The keyspace id this region is in, if any.
	KeyspaceId uint32 `protobuf:"varint,9,opt,name=keyspace_id,json=keyspaceId,proto3" json:"keyspace_id,omitempty"`
	/// The keyspace name (useful for debugging)
	KeyspaceName         uint32   `protobuf:"varint,10,opt,name=keyspace_name,json=keyspaceName,proto3" json:"keyspace_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Region) GetKeyspaceName() uint32 {
	if m != nil {
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.KeyspaceName != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.KeyspaceName))
		i--
		dAtA[i] = 0x50
	}
	if m.KeyspaceId != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.KeyspaceId))
		i--
		dAtA[i] = 0x48
	}
...
func (m *Region) Size() (n int) {
	...
	if m.KeyspaceName != 0 {
		n += 1 + sovMetapb(uint64(m.KeyspaceName))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KeyspaceName |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
